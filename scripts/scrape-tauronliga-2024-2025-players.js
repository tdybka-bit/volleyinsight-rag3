/**
 * TAURONLIGA 2024-2025 - Players Scraper
...
const DELAY_MS = 3000;
const PLAYERS_LIST_FILE = path.join(__dirname, '..', 'data', 'tauronliga-2024-2025', 'players-list.json');
...
async function main() {
  ...
  const outputDir = path.join(__dirname, '..', 'data', 'tauronliga-2024-2025');
