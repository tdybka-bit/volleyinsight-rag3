/**
 * TAURONLIGA 2023-2024 - Players List Scraper
 * Usage: node scripts/scrape-tauronliga-2023-2024-list.js
 */
...
const RANKING_URL = `${BASE_URL}/statsPlayers/tournament_1/45.html`;
