/**
 * PLUSLIGA 2022-2023 - Players Scraper
 * Usage: node scripts/scrape-plusliga-2022-2023-players.js [count] or [start] [end]
 */
...
const DELAY_MS = 3000;
const PLAYERS_LIST_FILE = path.join(__dirname, '..', 'data', 'plusliga-2022-2023', 'players-list.json');
...
async function fetchPlayerPage(playerId) {
  const url = `${BASE_URL}/statsPlayers/tournament_1/41/id/${playerId}.html`;
...
async function main() {
  ...
  const outputDir = path.join(__dirname, '..', 'data', 'plusliga-2022-2023');
