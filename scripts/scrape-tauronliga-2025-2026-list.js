/**
 * TAURONLIGA 2025-2026 - Players List Scraper
 * Usage: node scripts/scrape-tauronliga-2025-2026-list.js
 */
...
const RANKING_URL = `${BASE_URL}/statsPlayers/tournament_1/50.html`;
