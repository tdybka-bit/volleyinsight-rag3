/**
 * PLUSLIGA 2023-2024 - Players Scraper
 * Usage: node scripts/scrape-plusliga-2023-2024-players.js [count] or [start] [end]
 */
...
const DELAY_MS = 3000;
const PLAYERS_LIST_FILE = path.join(__dirname, '..', 'data', 'plusliga-2023-2024', 'players-list.json');
...
async function fetchPlayerPage(playerId) {
  const url = `${BASE_URL}/statsPlayers/tournament_1/44/id/${playerId}.html`;
