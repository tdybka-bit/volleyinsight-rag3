/**
 * PLUSLIGA 2022-2023 - Players List Scraper
 * Usage: node scripts/scrape-plusliga-2022-2023-list.js
 */
...
const RANKING_URL = `${BASE_URL}/statsPlayers/tournament_1/41.html`;
